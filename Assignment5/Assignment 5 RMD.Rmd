...
emisisons_year = array(data = data, 
dim=c(5,4,2),
dimnames = list(paste('Transportation', 'Electricity_Generation', 'Residential', 'Commercial', 'Industrial'),
                paste('Fuel_Type'),
                paste(2010,2016)))
...
test_that("Average natural gas emissions are numerical", {
  expect_is(average_ng("result"), "numeric")
})
