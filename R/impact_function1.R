...
#' @example load in ghg dataset with fuel type, to compute total emissions then divide by 10 and multiply by 0.2 to figure out the planetary warming from CO2 emissions. 
